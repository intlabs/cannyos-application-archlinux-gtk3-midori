#!/bin/sh
#
# CannyOS cannyos-application-archlinux-gtk3-midori container build script
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-application-archlinux-gtk3-midori/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo mkdir -p "/CannyOS/build/cannyos-application-archlinux-gtk3-midori"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-application-archlinux-gtk3-midori/*"
...
sudo docker run -i -t -d \
 ...
 --user "root" \
 -p 80 \
 intlabs/cannyos-application-archlinux-gtk3-midori 
